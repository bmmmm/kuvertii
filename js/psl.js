// Generated by tools/build-psl.mjs. Do not edit.
//
// Public Suffix List (ICANN + PRIVATE sections), MPL-2.0, from https://publicsuffix.org/list/public_suffix_list.dat
// 8515 suffixes, 283 wildcard rules, 8 exceptions.
//
...
export const EXACT = new Set(`0.bg
0am.jp
0g0.jp
0j0.jp
0t0.jp
...
export const WILDCARD = new Set(`001.test.code-builder-stg.platform.salesforce.com
0e.vc
0emm.com
aa.crm.dev
ab.crm.dev
...
export const EXCEPTION = new Set(`city.kawasaki.jp
city.kitakyushu.jp
city.kobe.jp
city.nagoya.jp
city.sapporo.jp
